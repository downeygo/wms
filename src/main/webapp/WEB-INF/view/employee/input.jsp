            ...
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                ...
                <s:if test="employee.id==null">
                    <tr>
                        ...
                        <td class="ui_text_lt">
                            <s:password name="employee.password" cssClass="ui_input_txt02"/>
                        </td>
                    </tr>
                    <tr>
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <s:select list="#depts" name="employee.dept.id" cssClass="ui_select01" listValue="name"
                                  listKey="id"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <tr>
                        ...
                        <td class="ui_text_lt">
                            <table>
                                <tr>
                                    <td>
                                        <s:select list="#roles" multiple="true" listValue="name" listKey="id" cssClass="ui_multiselect01 left_select"/>
                                    </td>
                                    <td align="center">
                                    ...
                                    <td>
                                        <s:select list="employee.roles" name="employee.roles.id" multiple="true" listValue="name" listKey="id" cssClass="ui_multiselect01 right_select"/>
                                    </td>
                                </tr>
                            </table>
                        </td>
