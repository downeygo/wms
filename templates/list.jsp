        ...
        <div class="ui_content">
            <div class="ui_text_indent">
                <div id="box_border">
                    ...
                    <div id="box_bottom">
                        <input type="button" value="新增" class="ui_input_btn01 btn_input" data-url="<s:url namespace="/" action="${objectName}_input"/>"/>
                    </div>
                </div>
            </div>
        </div>
                ...
                <table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
                    ...
                    <s:iterator value="#pageResult.result">
                        <tr>
                            ...
                            <td>
                                <s:url var="editUrl" namespace="/" action="${objectName}_input">
                                    <s:param name="${objectName}.id" value="id"/>
                                </s:url>
                                <a href="<s:property value="editUrl"/>">编辑</a>

                                <s:url var="deleteUrl" namespace="/" action="${objectName}_delete">
                                    <s:param name="${objectName}.id" value="id"/>
                                </s:url>
